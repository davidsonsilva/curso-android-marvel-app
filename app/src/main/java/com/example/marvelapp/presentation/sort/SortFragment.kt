...
class SortFragment : BottomSheetDialogFragment() {
    ...
    private var orderBy: String = SortingType.ORDER_BY_NAME.value
    private var order: String = SortingType.ORDER_ASCENDING.value
        ...
        viewModel.state.observe(viewLifecycleOwner) { uiState ->
            when(uiState){
                is SortViewModel.UiState.SortingResult -> {
                    val orderBy = uiState.sortedSorting.first
                    val order = uiState.sortedSorting.second
